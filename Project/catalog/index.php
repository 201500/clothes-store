...
<div class="container">
     <div class="row">
         <div id="cur2" class="col-lg-6">
             <button type="button" class="btn btn-secondary" onclick="man()">Man</button>
         </div>
         <div id="cur2" class="col-lg-6">
             <button type="button" class="btn btn-secondary" onclick="woman()">Woman</button>
         </div>
     </div>
</div>
